...
exports.generateAppHomeCalendar = generateAppHomeCalendar;
exports.extractDateFromAction = extractDateFromAction;
function generateAppHomeCalendar() {
...
function extractDateFromAction(action_id) {
    if (action_id.startsWith('date_')) {
        return action_id.substring(5); // Remove 'date_' prefix
    }
    return null;
}
//# sourceMappingURL=app-home-calendar.js.map